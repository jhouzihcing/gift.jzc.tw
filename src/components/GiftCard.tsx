  ...
  return (
    <div className="relative shrink-0 w-[82vw] max-w-[320px] bg-white rounded-[2.5rem] shadow-[var(--card-shadow)] overflow-hidden flex flex-col items-center p-7 border border-slate-100 snap-center transition-all">
      ...
      <div className="absolute top-0 right-8 flex flex-col items-center">
         ...
         <div className="bg-gradient-to-b from-[#34c759] to-[#28cd41] px-3 py-1 rounded-full shadow-lg shadow-[#34c759]/20">
            <span className="text-[7px] font-black text-white uppercase tracking-tighter">Verified</span>
         </div>
      </div>

      {/* 商家與面額 */}
      <div className="w-full text-center space-y-1 mb-6 relative z-10">
        <h3 className="text-sm font-black text-slate-300 tracking-[0.2em] uppercase">{card.merchant}</h3>
        <div className="flex items-center justify-center gap-0.5">
          <span className="text-xl font-black text-[#34c759]">$</span>
      ...
      <div className="w-full flex flex-col gap-8 items-center overflow-hidden relative z-10">
        ...
        <div className="flex flex-col items-center gap-2.5 w-full">
          <p className="text-[9px] text-slate-400 font-black uppercase tracking-[0.15em]">第一段條碼 (卡號)</p>
          <div className="bg-white p-4 border border-slate-100 rounded-[1.25rem] w-full flex justify-center shadow-sm">
            <Barcode 
              value={card.barcode} 
              width={1.4} 
              height={56} 
        ...
        {card.secondaryBarcode && (
          <div className="flex flex-col items-center gap-2.5 w-full">
            <p className="text-[9px] text-slate-400 font-black uppercase tracking-[0.15em]">第二段條碼 (密碼)</p>
            <div className="bg-white p-4 border border-slate-100 rounded-[1.25rem] w-full flex justify-center shadow-sm">
              <Barcode 
